    ...
    <section className="py-24 md:py-32 bg-slate-50 border-b border-slate-200 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <h2 className="tech-mono text-sm text-accent-orange mb-4 tracking-widest font-bold">THE VINGYAN INTELLIGENCE CORE</h2>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 md:gap-0">
          ...
          <div className="flex flex-col gap-8 md:w-[35%] relative z-20">
            {/* Node 1: IoT */}
            <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md hover:border-accent-orange/50 transition-all w-full relative">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-accent-orange/10 rounded-xl flex items-center justify-center border border-accent-orange/20">
              ...
              <Link href="/industries/iot" className="text-accent-orange text-sm font-bold flex items-center hover:text-primary transition-colors">
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md hover:border-accent-orange/50 transition-all w-full relative">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-accent-orange/10 rounded-xl flex items-center justify-center border border-accent-orange/20">
                  <LineChart className="h-5 w-5 text-accent-orange" />
                </div>
          ...
          <div className="hidden md:flex w-[30%] justify-center relative z-20">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 opacity-40 pointer-events-none">
              <NeuralNodes className="w-[400px] h-[400px] text-accent-orange/80" />
            </div>
            ...
            <div className="w-48 h-48 rounded-full bg-white shadow-xl shadow-slate-200/50 border border-slate-200 flex flex-col items-center justify-center relative z-20">
              <div className="absolute inset-0 rounded-full border-2 border-accent-orange border-dashed animate-[spin_20s_linear_infinite] opacity-50" />
              <div className="w-32 h-32 rounded-full shadow-lg shadow-accent-orange/30 flex items-center justify-center text-white text-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-tr from-accent-orange to-accent-yellow opacity-90" />
          ...
          <div className="flex flex-col gap-8 md:w-[35%] relative z-20">
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md hover:border-accent-blue/50 transition-all w-full relative">
              <div className="flex items-center gap-3 mb-4">
              ...
              <Link href="/industries/computer-vision" className="text-accent-blue text-sm font-bold flex items-center hover:text-accent-blue/80 transition-colors">
                View Systems <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            </div>

            {/* Node 4: Automation */}
            <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md hover:border-accent-green/50 transition-all w-full relative">
              <div className="flex items-center gap-3 mb-4">
