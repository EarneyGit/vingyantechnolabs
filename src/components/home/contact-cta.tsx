...
export function ContactCta() {
  return (
    <section className="py-24 bg-indigo-600 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 to-violet-700 opacity-90 pointer-events-none" />
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-400/30 rounded-full blur-[80px] pointer-events-none translate-y-1/3 -translate-x-1/4" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
        ...
        <Button asChild size="lg" className="bg-white text-indigo-700 hover:bg-slate-50 hover:text-indigo-800 font-bold h-14 px-8 rounded-full shadow-lg shadow-black/10 hover:shadow-xl hover:scale-[1.02] transition-all">
